...
const EqualizationPage = () => {
  ...
  const handleImageUpload1 = (event) => {
    ...
    image.onload = () => {
      ...
      const grayscaleData = new ImageData(
        new Uint8ClampedArray([...grayscaleMatrix, ...Array(4 * image.width * image.height - grayscaleMatrix.length).fill(0)]),
        image.width,
        image.height
      );
  ...
  return (
    <>
      ...
      <div className="flex p-10">
        <div className="mb-16 w-full">
          ...
          <div className="lg:w-1/2 flex flex-col gap-5">
            <h2>Matrix Before Image Source Histogram Equalization</h2>
            <HistogramChart
          ...
          <div className="lg:w-1/2 flex flex-col gap-5">
            <h2>Matrix After Image Source Histogram Equalization</h2>
            <HistogramChart
      ...
      <canvas ref={canvasRefOutput} style={{ border: "1px solid black" }} />
    </>
  );
};
